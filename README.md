...
🚀 Building IoT dashboards, scalable cloud apps, and modern web solutions.  

📍 Based in Dhaka, Bangladesh  
🌐 Portfolio: [xfishery.com](https://xfishery.com)
...
## 📂 Projects
### [Xfishery Sensor Dashboard](https://xfishery.com)
- Node.js backend hosted on AWS EC2  
...
- ✅ Strong MERN stack & Node.js skills  
- ✅ Cloud Deployment on AWS EC2 & SSL integration  
- ✅ Real-time IoT dashboards and web apps  
- ✅ Focused on UX/UI and modern responsive design  

---

### 💬 Fun Fact
I love combining **IoT, cloud, and full-stack development** to create **practical applications that solve real-world problems**.  
