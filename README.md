...
## 👨‍💻 About Me
Hey! I’m **Shahriar Hossain**, a **Full Stack Developer** and **technology enthusiast** who loves exploring new frameworks and solving real-world problems through code.  
...
- Real-time data systems & automation  
...
A real-time aquaculture monitoring platform that connects sensors to a smart analytics dashboard.  
**Stack:** Node.js • React • WebSockets/MQTT • MongoDB • Cloud APIs  

---

### 💊 [MediTrack Pharmacy SaaS](https://meditrack-v1.vercel.app)  
A SaaS web application for pharmacies to manage inventory, billing, and reports with multi-role access.  
**Stack:** MERN Stack • JWT Auth • HTTPS • Nginx • AWS EC2  

---

### ⚖️ [Lex.AI Legal Assistant](#)  
An AI-powered chatbot that assists professionals with legal workflow automation.  
**Role:** Co-Founder — focused on backend integration and API workflows.  
...
## 🧩 Highlights
- Built full-stack dashboards combining performance & modern UI/UX  
- Integrated **ESP32** sensors into real-time data systems  
- **CTO at Xfishery** — managing cloud & data architecture design  
- **Co-Founder at Lex.AI** — leading API automation & conversational backend  
- Always curious and eager to explore emerging technologies  

---

## 💬 Philosophy
> “Curiosity is the root of innovation — I build, break, and rebuild to learn what truly works.”  
> – Shahriar Hossain  
