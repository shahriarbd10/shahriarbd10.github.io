...
🚀 Building IoT dashboards, custom web apps, and scalable cloud solutions.  
...
- Node.js backend + AWS EC2 deployment  
- Real-time IoT sensor monitoring (water pH, temperature, ammonia, oxygen)  
- Integrated with custom domain and SSL (HTTPS)
